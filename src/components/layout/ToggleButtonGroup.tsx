...
export default function ToggleButtonGroup({
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className="fixed right-2 bottom-2 z-50 flex flex-col items-end gap-2 sm:right-4 sm:bottom-4 sm:gap-3 md:right-8 md:bottom-6"
        ...
        >
          {buttons.map((button, index) => (
            <Button
              ...
              className={cn(
                "min-w-[100px] justify-start text-sm sm:min-w-[120px] sm:text-base",
                button.active &&
